# Extracted from google/adk-samples/python/agents/llm-auditor/sub_agents/
# Part of the Universal ADK Agent Starter Kit
# Original source: https://github.com/google/adk-samples/python/agents/llm-auditor/sub_agents/
